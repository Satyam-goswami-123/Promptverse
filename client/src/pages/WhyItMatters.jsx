            ...
            <section className="page-hero">
                <div className="container">
                    ...
                    <p className="page-subtitle reveal" style={{ transitionDelay: '0.2s' }}>
                        Discover why prompt engineering has become a critical skill in the AI era and how it impacts real-world applications.
                    </p>
                </div>
            </section>
                    ...
                    <div className="content-wrapper">
                        ...
                        <div className="page-nav reveal">
                            <NavLink to="/what-is-pe" className="page-nav-link prev">
                                ...
                                <span className="page-nav-title">What is PE?</span>
                            </NavLink>
